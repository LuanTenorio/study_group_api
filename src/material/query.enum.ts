export enum MaterialQuery{
    ...
    CREATE = "INSERT INTO tb_material (user_id, group_id, file_size, file_content, file_type, uploaded_at, description) VALUES ($1, $2, $3, $4, $5, now(), $6) RETURNING *",
    UPDATE = "UPDATE tb_material SET file_size = $1, file_content = $2, file_type = $3, description = $4 WHERE id = $5 RETURNING *",
