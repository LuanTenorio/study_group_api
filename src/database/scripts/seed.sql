...
CALL create_group_study('Estudos de SQL Avancado', ARRAY[1, 5], 1);
CALL create_group_study('Leitura de Artigos em IA', ARRAY[2, 5], 3);
CALL create_group_study('Projeto de Engenharia de Software', ARRAY[3, 1], 2);
CALL create_group_study('Monitoria de Redes', ARRAY[4, 6], 4);
CALL create_group_study('Leitura de Artigos em Redes', ARRAY[4], 5);
CALL create_group_study('Laboratório de Ciência de Dados e Big Data', ARRAY[8, 2, 1], 6);
...
(1, 5, 'active', 'member', '2026-04-20'),
(2, 6, 'active', 'member', '2026-04-22'),
(3, 6, 'active', 'member', '2026-04-23');
...
(6, 6, 'Setup de Ambiente', '2026-07-25 15:00:00', 'Instalação e configuração de Pandas, PyTorch e Jupyter', 'Laboratório CIC 04');
...
(6, 'Dataset Titanic', 6, 5120, decode('4353562d444154415345542d544954414e4943', 'hex'), 'text/csv', '2026-06-18 14:00:00', 'Dataset clássico para treino de Machine Learning');
...
(6, 6, 'Instalação do Python', '2026-06-25 23:59:00', '2026-06-18 10:00:00', 'Por favor, instalem o Python 3.11+ e o Anaconda antes do nosso primeiro laboratório.');
...
(2, 6, '2026-06-18 15:30:00', 'Já baixei o dataset! Ansioso para começarmos a análise.');